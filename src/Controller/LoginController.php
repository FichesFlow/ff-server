...
final class LoginController extends AbstractController
{
    ...
    public function register(EntityManagerInterface $entityManager, UserPasswordHasherInterface $hasher): JsonResponse
    {
    ...
    public function login_check(UserRepository $userRepository, UserPasswordHasherInterface $passwordHasher, 
